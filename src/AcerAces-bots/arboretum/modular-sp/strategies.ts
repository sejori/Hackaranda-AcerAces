...
export let activeStrategies = {
    draw: strategicDraw as DrawStrategy,
    play: strategicPlay as PlayStrategy,
    discard: strategicDiscard as DiscardStrategy
};
...
// Apply a preset
export function applyPreset(presetName: keyof typeof strategyPresets) {
